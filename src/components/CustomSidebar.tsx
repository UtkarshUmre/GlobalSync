...
export const Logo = () => {
  return (
    ...
    >
      <div className="h-5 w-6 bg-gradient-to-r from-cyan-300 to-blue-500 rounded-br-lg rounded-tr-sm rounded-tl-lg rounded-bl-sm flex-shrink-0" />
      <motion.span
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        GlobalSync
        <p className="text-xs text-neutral-400">Workforce Management</p>
      </motion.span>
    </Link>
  );
};
